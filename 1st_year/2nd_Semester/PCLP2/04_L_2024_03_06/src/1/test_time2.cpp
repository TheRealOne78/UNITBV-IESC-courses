...
int main() {
  ...
  cout << endl << " ";
  t1.printLong();
  cout << "\nhour specificat; minute si second implicite:" << endl << " ";
  t2.printShort();
  cout << endl << " ";
  t2.printLong();
  cout << "\nhour si minute specificate; second implicit:" << endl << " ";
  t3.printShort();
  cout << endl << " ";
  t3.printLong();
  cout << "\nhour, minute si second specificate:" << endl << " ";
  t4.printShort();
  cout << endl << " ";
  t4.printLong();
  cout << "\nvalori invalide pentru hour, minute si second:" << endl << " ";
  t5.printShort();
  cout << endl << " ";
  t5.printLong();
  cout << endl;
