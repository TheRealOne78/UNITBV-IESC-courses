...
void ll_push(t_llist *list, int64_t a) {
    ...
    t_llist *p_new  = (t_llist*) malloc(sizeof(t_llist));
    p_new->data      = a;
    if(p_last != NULL)
        p_last->p_next   = p_new;
}
...
void dll_add_n(t_dllist *list, uint64_t n, int64_t a) {
    ...
    t_dllist *tmp_p_new = (t_dllist*)malloc(sizeof(t_llist));

    tmp_p_new->data            = a;
    tmp_p_new->p_next          = tmp_p_list->p_next;
    tmp_p_list->p_next->p_prev = tmp_p_new;
    tmp_p_new->p_prev          = tmp_p_list;
    tmp_p_list->p_next         = tmp_p_new;
}
...
void ll_add_n(t_llist *list, uint64_t n, int64_t a) {
    ...
    t_llist *tmp_p_new = (t_llist*)malloc(sizeof(t_llist));
